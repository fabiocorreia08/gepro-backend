package br.gov.cmb.gepro.model;
...
public class Protocolo {
    ...
    private String identidadePrimaria;
    @Column(name="NM_IDENT_SECND" ,length=100)
    private String identidadeSecundaria;
	...
	public String getIdentidadePrimaria() {
		return identidadePrimaria;
	}
	public void setIdentidadePrimaria(String identidadePrimaria) {
		this.identidadePrimaria = identidadePrimaria;
	}
	public String getIdentidadeSecundaria() {
		return identidadeSecundaria;
	}
	public void setIdentidadeSecundaria(String identidadeSecundaria) {
	...
	public Date getNaturalidade() {
		return naturalidade;
	}
	public void setNaturalidade(Date naturalidade) {
